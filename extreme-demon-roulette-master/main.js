...
<div class="box ${animation ? 'animate__animated animate__' + animation : ''}">
    <div class="columns is-1">
        ...
        <div class="column">
            <a href="https://gdchallengelist.com/api/v1/demons/?limit=100'S${demon.position}/"><h1 class="title" id="current-title">#${demon.position} - ${demon.name}</h1></a>
...
<div class="box has-text-centered animate__animated animate__fadeInUp">
    ...
    <div class="content is-medium">
        <p>
        Number of Challenges: ${currentChallenge} <br>
